...
object FirebaseModule {
    ...
    @Provides
    @Singleton
    fun provideGetStoriesByCollection(firebaseRepository: FirebaseRepository) : GetStoriesByCollectionUseCase {
        return GetStoriesByCollectionUseCase(firebaseRepository)
    }
